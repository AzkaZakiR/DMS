    ...
    <div class="row h-100 w-100 m-0">
        ...
        <div class="col" style="background: #DFD9D9;">
            ...
            <div class="row mt-3 p-3">
                ...
                <div class="col offset-1 mr-3" style="background: white;">
                    ...
                    <div class="row m-3">
                        <div class="form-group">
                            ...
                            <textarea cols="40" rows="3" style="resize:none" name="alamat"></textarea>
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="form-group">
                    ...
                    <div class="row m-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" style="width:300px;text-align:center" name="operational_time">
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" style="width:300px;text-align:center" name="operational_time_close">
                        </div>
                    </div>
                    {{-- Social Media --}}
                    <div class="row m-3">
                ...
                {{-- Right Section --}}
                <div class="col">
                <div class="card" style="width: 34.6rem;">
                <div class="card-body">
                    <h5 class="card-title">Description :</h5>
                    <textarea cols="70" rows="11" style="resize:none" name="description"></textarea>
                </div>
                </div>
                <div class="row w-75">
                <div class="col-md-6 ">
                <div class="card mt-2" style="width:17.1rem;">
                <div class="card-body">
                    <h5 class="card-title">Vision :</h5>
                    <textarea cols="30" rows="12" style="resize:none" name="vision"></textarea>
                </div>
                </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <textarea cols="30" rows="12" style="resize:none" name="mission"></textarea>
                </div>
                </div>
                </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mt-2" style="width:34.6rem;">
                            <div class="card-body">
                                <h5 class="card-title mt-1">Type Of Business : <select id="business" name="type">
