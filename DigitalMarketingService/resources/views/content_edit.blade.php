...
<body>
    ...
    <div class="row h-100 w-100 m-0">
        ...
        @endif
            ...
            <form action="{{ route('Itempages.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                        ...
                        {{-- Deskripsi --}}
                            <div class="row m-3">
                                <div class="form-group">
                                    ...
                                    <textarea cols="40" rows="3" style="resize:none" name="keterangan">{{ $itempages->keterangan }}</textarea>
                                </div>
                            </div>
                            {{--Upload Images --}}
                            <div class="col-md-6">
